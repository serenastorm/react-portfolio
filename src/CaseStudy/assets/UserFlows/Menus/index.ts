...
import Menus2Bg from "./menus2a.jpg";
import Menus2Color from "./menus2b.png";

export const MenusImages = {
  HomePage: MenusHomepage,
  Panel: [Menus1Spacer, Menus1Menu, Menus1Panel, Menus1BackBtn, Menus1Actions],
  Customisation: [Menus2Bg, Menus2Color],
  EditItem: Menus3,
};
